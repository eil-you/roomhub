...
public enum ErrorCode {
    ...
    REQUIRED_TERMS_CHECKED(1024, "Required terms must be checked"),
    PHONENUMBER_COOLDOWN(1025, "Phone number is not allowed within 1 hour"),
    NICKNAME_IS_DUPLICATE(1026, "Nickname is duplicate"),
    CODE_NOT_MATCHED(1027, "Code not matched"),
    CODE_EXPIRED(1028, "Code expired"),
    ALREADY_REGISTERED(1029, "Already registered User"),
    CODE_IS_EMPTY(1030, "Code not found"),
    PHONENUMBER_FAILED_ENCRYPT(1031, "Phone number failed to encrypt"),
    PHONENUMBER_FAILED_DECRYPT(1032, "Phone number failed to decrypt"),
